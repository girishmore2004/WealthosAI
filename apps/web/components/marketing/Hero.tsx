    ...
    <section className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 sm:pt-24">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <a
            href="#how-it-works"
            className="w-full rounded-md border border-line bg-surface px-6 py-3 text-sm font-medium text-ink transition-colors hover:border-ink-faint hover:bg-surface-muted sm:w-auto"
          >
            See how it works
          </a>
        </div>
